...
const addMatrices = function(matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        console.log("The Matrix addition will not possible.");
        return null;
    }
...
const subtractMatrices = function(matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        console.log("The Matrix subtraction will not possible.");
        return null;
    }
...
const multiplyMatrices = function(matrix1, matrix2) {
    if (matrix1[0].length !== matrix2.length) {
        console.log("The Matrix multiplication will not possible.");
        return null;
    }
